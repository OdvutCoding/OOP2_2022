...
namespace Course_Organizer
{
    public partial class Signup_Form : Form
    {
      ...
      //  SqlCommand cmd = new SqlCommand();
            ...
            using (SqlConnection sqlCon = new SqlConnection(connectionString))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if(txt_pw.Text==txt_pw_retype.Text)
                            {
                            ...
                            {
                                Prompt.Visible = true;
                                Prompt.Text = "Password did not match.";
                            }
                        }
                    }
                }
        ...
        {
            Button_Register.ForeColor = Color.Orange;
        }
        ...
        private void Clear_signup_MouseHover(object sender, EventArgs e)
        {
            Clear_signup.ForeColor = Color.Purple;
        }

        private void Clear_signup_MouseLeave(object sender, EventArgs e)
        {
            Clear_signup.ForeColor = Color.RoyalBlue;
        }
    }
}
