...
namespace Course_Organizer
{
    public partial class Form_User : Form
    {
        ...
        private void Button_Addcourse_MouseHover(object sender, EventArgs e)
        {
            Button_Addcourse.ForeColor = Color.Violet;
        }

        private void Button_Addcourse_MouseLeave(object sender, EventArgs e)
        {
            Button_Addcourse.ForeColor = Color.White;
        }

        private void Button_Browsecourse_MouseHover(object sender, EventArgs e)
        {
            Button_Browsecourse.ForeColor = Color.Violet;
        }

        private void Button_Browsecourse_MouseLeave(object sender, EventArgs e)
        {
            Button_Browsecourse.ForeColor = Color.White;
        }

        private void Button_Editcourse_MouseHover(object sender, EventArgs e)
        {
            Button_Editcourse.ForeColor = Color.Violet;
        }

        private void Button_Editcourse_MouseLeave(object sender, EventArgs e)
        {
            Button_Editcourse.ForeColor = Color.White;
        }
    }
}
