...
namespace Course_Organizer
{
    public partial class Signin_Form : Form
    {
      ...
      //  public static string username;
        ...
        public string mycon = ConfigurationManager.ConnectionStrings["connstring"].ConnectionString;
        ...
        private void Button_login_Click(object sender, EventArgs e)
        {
          ...
          /*
           //Lecturer's Way - Bad Practice according to professionals
            string sql = "select* from user_table where  username = ' " + this.textbox_username.Text + " ' and password = ' " + this.textBox_password.Text + " '   ";
            SqlConnection sqlCon = new SqlConnection(@"Data Source=XARVIS;Initial Catalog=Course Organizer;Integrated Security=True");
